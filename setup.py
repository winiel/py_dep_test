...
setup(
    name='depTest',
    version='1.0',
    packages=['venv.lib.python3.5.site-packages.urllib3', 'venv.lib.python3.5.site-packages.urllib3.util',
              ...
              'venv.lib.python3.5.site-packages.selenium', 'venv.lib.python3.5.site-packages.selenium.common',
              'venv.lib.python3.5.site-packages.selenium.webdriver',
              'venv.lib.python3.5.site-packages.selenium.webdriver.ie',
              'venv.lib.python3.5.site-packages.selenium.webdriver.edge',
              'venv.lib.python3.5.site-packages.selenium.webdriver.opera',
              'venv.lib.python3.5.site-packages.selenium.webdriver.chrome',
              'venv.lib.python3.5.site-packages.selenium.webdriver.common',
              'venv.lib.python3.5.site-packages.selenium.webdriver.common.html5',
              'venv.lib.python3.5.site-packages.selenium.webdriver.common.actions',
              'venv.lib.python3.5.site-packages.selenium.webdriver.remote',
              'venv.lib.python3.5.site-packages.selenium.webdriver.safari',
              'venv.lib.python3.5.site-packages.selenium.webdriver.android',
              'venv.lib.python3.5.site-packages.selenium.webdriver.firefox',
              'venv.lib.python3.5.site-packages.selenium.webdriver.support',
              'venv.lib.python3.5.site-packages.selenium.webdriver.phantomjs',
              'venv.lib.python3.5.site-packages.selenium.webdriver.webkitgtk',
              'venv.lib.python3.5.site-packages.selenium.webdriver.blackberry',
              ...
              'venv.lib.python3.5.site-packages.pip-10.0.1-py3.5.egg.pip._internal.operations'],
    url='',
    license='',
    author='winiel',
    author_email='',
